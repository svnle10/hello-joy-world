...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'account.new_password_placeholder': 'Enter new password (min 6 characters)',
    ...
    'analytics.pending_requests': 'Pending Requests',
    ...
    'analytics.pending_leave': 'Pending Leave Requests',
    'analytics.requested_at': 'Requested at',
    'analytics.approve': 'Approve',
    'analytics.reject': 'Reject',
    'analytics.reject_request': 'Reject Leave Request',
    'analytics.reject_confirm': 'Are you sure you want to reject the request of',
    'analytics.reject_reason': 'Rejection reason (optional)',
    'analytics.confirm_reject': 'Confirm Rejection',
    'analytics.approved': 'Request approved',
    'analytics.rejected': 'Request rejected',
  ...
  fr: {
    ...
    'account.current_password_placeholder': 'Entrez le mot de passe actuel',
    'account.new_password_placeholder': 'Entrez le nouveau mot de passe (min 6 caractères)',
    'account.confirm_password_placeholder': 'Confirmez le nouveau mot de passe',
    'account.save_password': 'Enregistrer',
    'account.password_changed': 'Mot de passe changé avec succès',
    'account.password_change_failed': 'Échec du changement de mot de passe',
    ...
    'analytics.pending_requests': 'Demandes en Attente',
    ...
    'analytics.pending_leave': 'Demandes de Congé en Attente',
    'analytics.requested_at': 'Demandé le',
    'analytics.approve': 'Approuver',
    'analytics.reject': 'Refuser',
    'analytics.reject_request': 'Refuser la Demande de Congé',
    'analytics.reject_confirm': 'Êtes-vous sûr de vouloir refuser la demande de',
    'analytics.reject_reason': 'Raison du refus (optionnel)',
    'analytics.confirm_reject': 'Confirmer le Refus',
    'analytics.approved': 'Demande approuvée',
    'analytics.rejected': 'Demande refusée',
  ...
  ar: {
    ...
    'account.change_password': 'تغيير كلمة السر',
    'account.current_password': 'كلمة السر الحالية',
    'account.new_password': 'كلمة السر الجديدة',
    'account.confirm_password': 'تأكيد كلمة السر',
    'account.current_password_placeholder': 'أدخل كلمة السر الحالية',
    'account.new_password_placeholder': 'أدخل كلمة السر الجديدة (6 أحرف على الأقل)',
    'account.confirm_password_placeholder': 'أكد كلمة السر الجديدة',
    'account.save_password': 'حفظ كلمة السر',
    'account.password_changed': 'تم تغيير كلمة السر بنجاح',
    'account.password_change_failed': 'فشل في تغيير كلمة السر',
    ...
    'analytics.pending_requests': 'طلبات معلقة',
    ...
    'analytics.pending_leave': 'طلبات أيام الراحة المعلقة',
    'analytics.requested_at': 'طلب في',
    'analytics.approve': 'قبول',
    'analytics.reject': 'رفض',
    'analytics.reject_request': 'رفض طلب الإجازة',
    'analytics.reject_confirm': 'هل أنت متأكد من رفض طلب',
    'analytics.reject_reason': 'سبب الرفض (اختياري)',
    'analytics.confirm_reject': 'تأكيد الرفض',
    'analytics.approved': 'تمت الموافقة على الطلب',
    'analytics.rejected': 'تم رفض الطلب',
